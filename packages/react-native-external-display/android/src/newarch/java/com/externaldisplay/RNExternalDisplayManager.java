...
import com.facebook.react.viewmanagers.RNExternalDisplayManagerDelegate;
import com.facebook.react.viewmanagers.RNExternalDisplayManagerInterface;
...
public class RNExternalDisplayManager extends ViewGroupManager<RNExternalDisplayView>
  ...
  public RNExternalDisplayManager(ReactApplicationContext reactContext) {
    ...
    mDelegate = new RNExternalDisplayManagerDelegate<>(this);
  }

  @Nullable
  @Override
  protected ViewManagerDelegate<RNExternalDisplayView> getDelegate() {
    return mDelegate;
  }
